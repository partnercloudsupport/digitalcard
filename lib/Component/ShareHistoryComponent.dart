                ...
                onPressed: () async {
                    ...
                    try {
                      if (permissionStatus ==
                        ...
                        Item item = Item(
                            label: 'office',
                            value: shareClass.MobileNo);

                        Contact newContact = new Contact(
                            givenName: shareClass.Name,
                            phones: [item]);
            ...
            Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 5),
                      child: Text(shareClass.Date.substring(3,shareClass.Date.length),
                          style: TextStyle(
