        ...
        body: Container(
          ...
          child: Stack(
            children: <Widget>[
              HeaderComponent(
                title: "Refer & Earn",
                image: "images/header/referheader.jpg",
                boxheight: 150,
              ),
              Container(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border:
                              Border.all(width: 2, color: cnst.buttoncolor),
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text("Invite your friends to sign up",
                                        style: TextStyle(
                                            fontSize: 13,
                                            fontWeight: FontWeight.w600,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                border:
                                Border.all(width: 3, color: cnst.buttoncolor),
                              ),
                            ),
                            Container(
                              width: (MediaQuery.of(context).size.width - 160) / 3,
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(top: 10),
                                    child: Text("Your friend get prooduct from us",
                                        style: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w600,
                                            color: Colors.grey[700])),
                      ...
                      GestureDetector(
                        onTap: (){
                          ...
                          key.currentState.showSnackBar(
                              new SnackBar(content: new Text("Code Copied"),duration: Duration(milliseconds: 2)));
                        },
                        child: Padding(
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                            ...
                            onPressed: () {
                              String withrefercode = cnst.inviteFriMsg.replaceAll("#refercode", ReferCode);
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 20),
                        child: Text("Notes : you can use earn points to purchase / renew your digital card membership",
                            style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.w600,
                                color: Colors.grey[500])),
